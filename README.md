...
Users input one or more Polymarket wallet addresses. These addresses are validated locally and stored in the browser’s localStorage.
...
Trades from all followed wallets are:
...
Each trade card contains a reference to its associated Polymarket market. Selecting “Copy Trade” opens:
...
Choose the project folder containing the extension files.

Pin the extension to your Chrome toolbar for quicker access.
